...
<img src="figure/esher.jpg" width="500" height="500" >  
...
ggplot(M2_diag, aes(x = .pears_resid)) + geom_histogram(fill = "blue", color = "black", bin = 0.2) + geom_vline(xintercept = 0, size = 1.2)
```
