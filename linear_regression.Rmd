...
## Симулированный пример {.smaller .columns-2}
...
## Задание: <br> Оцените частную корреляцию между уровнем интеллекта (PIQ) и размером головного мозга (MRINACount) под контролем размеров тела (Height) 
...
## Состоятельна ли модель, описывающая связь IQ и размера головного мозга? {.smaller}
...
## Проверка состоятельности модели с помощью F-критерия {.smaller .columns-2}  
