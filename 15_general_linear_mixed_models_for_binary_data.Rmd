...
ggplot(dat, aes(x=x, y=y)) + geom_smooth(method= "glm", family = "binomial", color = "red", size = 2)+ geom_point(aes(x=x, y=y), position = position_jitter(height = 0.01)) + geom_point(data = dat_fr, aes(x= x, y = y), size= 4, color = "blue")
...
<img src="figure/druse.png" width="400" > 

<img src="figure/drilled_barnacle.png" height="550" > 
...
<img align="middle" src="figure/design.png" width="600" height="400" > 
