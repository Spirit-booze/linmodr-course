...
gg_cu_factor <- gg_cu + 
  geom_hline(yintercept = gmean, linetype = "dashed") + 
  geom_errorbar(stat = "hline", size = 1, yintercept = function(length) mean(length, na.rm = TRUE),  width = .8, aes(ymax = ..y.., ymin = ..y..)) + 
...
gg_cu_error <- gg_cu + 
  ...
  geom_errorbar(stat = "hline",  size = 1, yintercept = function(length) mean(length, na.rm = TRUE), 
